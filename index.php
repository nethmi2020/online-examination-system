...
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="sign.php"  method="POST">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name1" name="name" placeholder="Enter your name" class="form-control input-md" type="text">
